...
//        mediaTypeList.add(new MediaType("text", "plain", DEFAULT_CHARSET));
//        mediaTypeList.add(MediaType.ALL);
//        super.setSupportedMediaTypes(mediaTypeList);

        super(new MediaType("text", "plain", DEFAULT_CHARSET), new MediaType("text", "html", DEFAULT_CHARSET),MediaType.ALL);
